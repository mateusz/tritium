#!/usr/bin/env python3
# This file was automatically generated by bundle_code.py
...
# From data_model/grapplable/grapplable.py
class Grapplable:
    """
...
# From data_model/facility/facility.py
class Facility(ABC):
...
# From data_model/resource/resource.py
class Resource(Enum):
    IRON = auto()
    TITANIUM = auto()
    ALUMINUM = auto()
...
# From data_model/rank/producer_rank.py
...
# From data_model/rank/researcher_rank.py
...
# From data_model/rank/rank.py
class Rank(Enum):
    pass


# From data_model/rank/marine_rank.py
...
# From textual/message_system.py
class Message:
...
# From data_model/grapplable/commspod_design.py
class CommspodDesign(Grapplable):
    pass


# From data_model/grapplable/artifact_part.py
class ArtifactPart(Grapplable):
    pass


# From data_model/facility/shuttle_bay.py
class ShuttleBay(Facility):
    """Shuttle bay facility"""
    pass


# From data_model/facility/mining.py
class Mining(Facility):
    """Mining facility"""
    pass


# From data_model/facility/spacedock.py
class Spacedock(Facility):
    """Spacedock for IOS and SCG"""
    pass


# From data_model/facility/storage.py
class Storage(Facility):
    """Storage facility"""
    pass


# From data_model/equipment/equipment.py
...
# From data_model/personnel/personnel.py
...
# From data_model/game_progression/game_progression.py
...
# From data_model/equipment/tests/equipment_test.py
class EquipmentTest(unittest.TestCase):
    ...
    def test_get_research_technician_days(self):
        ...
        self.assertEqual(advanced_equipment.get_research_technician_days(), 7000)


# From data_model/equipment/ship_equipment/ship_equipment.py
...
# From data_model/equipment/base_equipment/base_equipment.py
...
# From data_model/vehicle/vehicle.py
class Vehicle(ABC):
...
# From data_model/facility/training.py
class TrainingBatch:
...
# From data_model/personnel/producer.py
class Producer(Personnel):
    """Personnel specialized in production"""
    pass


# From data_model/personnel/researcher.py
...
# From data_model/personnel/marine.py
class Marine(Personnel):
    """Combat specialized personnel"""
    pass


# From data_model/game_progression/initial_progress.py
...
# From data_model/equipment/ship_equipment/auto_cargo_computer.py
...
# From data_model/equipment/ship_equipment/hyperspace.py
...
# From data_model/equipment/ship_equipment/drone_fleet_control_computer.py
...
# From data_model/equipment/ship_equipment/star_drone.py
...
# From data_model/equipment/ship_equipment/ios_battle_drone.py
...
# From data_model/equipment/ship_equipment/pod/pod.py
...
# From data_model/equipment/ship_equipment/chassis/chassis.py
...
# From data_model/equipment/ship_equipment/drive_unit/drive_unit.py
...
# From data_model/equipment/ship_equipment/tool/tool.py
...
# From data_model/equipment/base_equipment/mass_transciever.py
...
# From data_model/equipment/base_equipment/auto_operations_computer.py
...
# From data_model/equipment/base_equipment/fuz_laser.py
...
# From data_model/equipment/base_equipment/self_destruct_mechanism.py
...
# From data_model/equipment/base_equipment/derrick.py
...
# From data_model/vehicle/ios.py
class IOS(Vehicle):
    """IOS vehicle"""
    pass


# From data_model/vehicle/shuttle.py
class Shuttle(Vehicle):
    """Shuttle vehicle"""
    pass


# From data_model/vehicle/scg.py
class SCG(Vehicle):
    """SCG vehicle"""
    pass


# From data_model/base/base.py
class Base(ABC):
...
# From data_model/facility/production.py
...
# From data_model/facility/research.py
...
# From data_model/equipment/ship_equipment/pod/resource_pod.py
...
# From data_model/equipment/ship_equipment/pod/tool_pod.py
class ToolPod(Pod):
    """
    Tool pod equipment.
    """
...
# From data_model/equipment/ship_equipment/pod/prison_pod.py
class PrisonPod(Pod):
    """
...
# From data_model/equipment/ship_equipment/pod/cryo_pod.py
class CryoPod(Pod):
    """
    Cryo pod equipment.
    """
...
# From data_model/equipment/ship_equipment/chassis/scg_chassis.py
...
# From data_model/equipment/ship_equipment/chassis/ios_chassis.py
...
# From data_model/equipment/ship_equipment/chassis/shuttle_chassis.py
...
# From data_model/equipment/ship_equipment/drive_unit/ios_drive.py
...
# From data_model/equipment/ship_equipment/drive_unit/shuttle_drive.py
...
# From data_model/equipment/ship_equipment/drive_unit/scg_drive.py
...
# From data_model/equipment/ship_equipment/tool/complete_artifact.py
...
# From data_model/equipment/ship_equipment/tool/pulse_blast_laser.py
...
# From data_model/equipment/ship_equipment/tool/grapple.py
class Grapple(Tool):
    """
...
# From data_model/equipment/ship_equipment/tool/asteroid_mining_attachment.py
...
# From data_model/equipment/ship_equipment/tool/prejudice_torpedo_launcher.py
...
# From data_model/equipment/ship_equipment/tool/sonic_blaster.py
...
# From data_model/equipment/ship_equipment/tool/installation_repair_equipment.py
...
# From data_model/equipment/ship_equipment/tool/orbital_factory_frame.py
...
# From data_model/equipment/ship_equipment/tool/resource_factory_frame.py
...
# From data_model/equipment/ship_equipment/tool/communications_adapter.py
...
# From data_model/base/resource_base.py
...
# From data_model/base/orbital_base.py
...
# From data_model/base/earth_base.py
...
# From data_model/base/moon_base.py
...
# From data_model/location/location.py
class Location(ABC):
...
# From data_model/location/asteroid.py
class Asteroid(Location):
    """An asteroid location"""
    pass


# From data_model/location/moon.py
class Moon(Location):
    """A moon location"""
    pass


# From data_model/location/planet.py
class Planet(Location):
    """A planet location"""
    pass


# From data_model/system/system.py
class System(ABC):
...
# From data_model/system/solar_system.py
...
# From data_model/system/star_system.py
class StarSystem(System):
    """Non-Sun star system"""
    pass


# From data_model/game_state.py
class GameState:
...
# From coordinators/coordinator.py
class Coordinator:
    """
...
# From coordinators/equipment_coordinator.py
...
# From coordinators/training_coordinator.py
...
# From coordinators/time_coordinator.py
...
# From coordinators/research_coordinator.py
...
# From coordinators/game_coordinator.py
...
# From textual/bases/earth_view.py
...
# From textual/facilities/training_view.py
...
# From textual/facilities/research_view.py
        ...
        # View commands
            ...
            if 1 <= index <= len(all_items):
                ...
                if status == 'researched':
                    ...
                    details += f"Production Location: {'Orbit' if equipment_data.orb


# From textual/game_runner.py
class GameRunner:
